...
const Profile = () => {
  ...
  return (
    <Layout>
       <div className="mx-auto md:my-16 shadow-xl rounded-xl p-6 md:p-10 md:w-7/12 w-11/12 bg-white border border-gray-200">
        ...
        orders.map((item,index)=>(
          <div key={index} className="flex gap-3 mb-8">
            <img src={item.image} className="w-[100px] rounded"/>
            <div>
              ...
              <button className={`mt-2 ${getStatusColor(item.status)} bg-green-500 rounded px-3 py-1 text-xs font-medium text-white capitalize`}>
               {item.status}
              </button>
            </div>
          </div>
      ...
      <div className="mx-auto md:my-16 shadow-xl rounded-xl p-6 md:p-10 md:w-7/12 w-11/12 bg-white border border-gray-200">
        ...
        <div className="w-28 h-28 mx-auto relative mb-8">
          {loading ? (
            ...
            <img
              src={profilePicture}
              className="rounded-full w-28 h-28 border-4 border-sky-600 shadow-lg object-cover"
              alt="Profile Avatar"
            />
          )}
          <input
      ...
      <div className="mx-auto md:my-16 shadow-xl rounded-xl p-6 md:p-10 md:w-7/12 w-11/12 bg-white border border-gray-200">
        <div className="flex flex-col md:flex-row gap-3 items-center mb-4">
          ...
          <h1 className="text-3xl font-bold text-gray-800">Delivery Address</h1>
        </div>
        <hr className="my-6 border-gray-300" />
